...
This project is a **practice/learning implementation** based on the "Simple Notes App" tutorial by **Shubham Londhe (TrainWithShubham)**.
...
## 📌 Note
- This is **not an original project** — full credit goes to Shubham Londhe for the original code and tutorial. This repo exists purely for hands-on Docker/Nginx/deployment practice.
